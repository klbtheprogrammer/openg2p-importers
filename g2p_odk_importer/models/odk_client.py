...
from odoo.addons.g2p_registry_rest_api.services.individual import IndividualApiService
from odoo.addons.g2p_registry_rest_api.models.individual import IndividualInfoIn
...
class ODKClient:
    ...
    # _name="odkclient"
    def __init__(self, env, base_url, username, password, project_id, form_id, target_registry, json_formatter = "."):
        print(base_url)
    ...
    def import_delta_records(self, last_sync_timestamp=None, skip=0, top=100, ):
        ...
        if last_sync_timestamp :
            ...
            params = {"$top": top, "$skip": skip, "$count": "true", "$expand": "*","$filter": "__system/submissionDate ge " + startdate}
        else :
        ...
        if request and request.session:
            ...
            response = requests.post('http://localhost:8069/session/auth/login',headers={'Content-Type': 'application/json'},params=payload, json=payload)
        ...
        for record in data["value"] :
            ...
            try:
                ...
                service_response = requests.post("http://localhost:8069/api/v1/registry/" + self.target_registry, headers=headers, data=mapped_json)
